        ...
        for (let file of files) {
            ...
            if (isValidPath(file) && fs_1.existsSync(fullPath) && path_1.extname(file) !== '.json' && !schema_from_typedefs_1.isGraphQLFile(fullPath)) {
                try {
                    ...
                    throw new aggregate_error_1.default([new Error(`Unable to load schem from file "${file}" due to import error: ${e}`), e]);
                }
            }
        }
        return false;
