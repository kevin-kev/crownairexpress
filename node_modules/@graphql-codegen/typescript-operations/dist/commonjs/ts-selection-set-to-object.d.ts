...
export declare class TypeScriptSelectionSetToObject extends SelectionSetToObject {
    private _config;
    constructor(_scalars: ScalarsMap, _schema: GraphQLSchema, _convertName: ConvertNameFn, _addTypename: boolean, _nonOptionalTypename: boolean, _loadedFragments: LoadedFragment[], _config: TypeScriptDocumentsParsedConfig, _parentSchemaType?: GraphQLNamedType, _selectionSet?: SelectionSetNode);
