...
class SelectionSetToObject {
    constructor(_scalars, _schema, _convertName, _addTypename, _nonOptionalTypename, _loadedFragments, _namespacedImportName, _parentSchemaType, _selectionSet) {
    ...
    buildTypeNameField() {
        const possibleTypes = [];
        if (graphql_1.isUnionType(this._parentSchemaType)) {
            return null;
        }
        else if (graphql_1.isInterfaceType(this._parentSchemaType)) {
