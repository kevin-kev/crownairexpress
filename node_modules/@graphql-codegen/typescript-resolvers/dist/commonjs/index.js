...
exports.plugin = (schema, documents, config) => {
    ...
    const visitor = new visitor_1.TypeScriptResolversVisitor(config, schema);
...
`;
    ...
    return {
        prepend: [`import { ${imports.join(', ')} } from 'graphql';`, ...mappersImports, visitor_plugin_common_1.OMIT_TYPE],
